...
//  This annotation maps the servlet to the specified URL
@WebServlet("/Enumerators_Register_Servlet")
public class Enumerators_Register_Servlet extends HttpServlet {
 ...
 */
     ...
     */
    public Enumerators_Register_Servlet() {
        super();
